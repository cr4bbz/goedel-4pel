...
Version 0.7 reports Gates 0--7. In addition to the semantic reconstruction through T3 and modal collapse, it records the Lean proofs, executable countermodels, bounded T2 assumption search, and interface-level classical recovery. The next phase compares semantic variants, beginning with support-based versus exact positive Godlikeness, before moving to literature-motivated variants and weaker modal frames.
