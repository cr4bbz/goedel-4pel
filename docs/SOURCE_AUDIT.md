...
| S4 | Fuenmayor & Benzmüller, “Types, Tableaus and Gödel’s God in Isabelle/HOL” (2017) | [AFP entry](https://isa-afp.org/entries/Types_Tableaus_and_Goedels_God.html) · [current proof outline](https://isa-afp.org/browser_info/current/AFP/Types_Tableaus_and_Goedels_God/outline.pdf) | Embedding §§2.2.3–2.2.5; Fitting §§5.1–5.5; Anderson §§6.1–6.4; sessions `FittingProof` and `AndersonProof` | Formal cross-check for the Anderson/Fitting architecture |
